...
return [
    ...
    'Captcha Errors' => 'Captcha Errors',
    'This setting defaults to the \'Forms\' section while the \'Save data to the Craft database\' setting is disabled.' => 'This setting defaults to the \'Forms\' section while the \'Save data to the Craft database\' setting is disabled.',
    'The tab that will be selected by default in the sidebar navigation.' => 'The tab that will be selected by default in the sidebar navigation.',
    'Entries marked as Not Spam.' => 'Entries marked as Not Spam.',
    'Track Remote IP' => 'Track Remote IP',
    'This setting is unavailable because saving data to the database is disabled in the [global settings]().' => 'This setting is unavailable because saving data to the database is disabled in the [global settings]().',
    'Mark as Spam' => 'Mark as Spam',
    'Failed to mark entry as Not Spam' => 'Failed to mark entry as Not Spam',
    'Are you sure you want to not mark as spam the selected form entries?' => 'Are you sure you want to not mark as spam the selected form entries?',
    'Spam' => 'Spam',
    'Overview of spam submissions' => 'Overview of spam submissions',
    'The section that will be selected by default in the sidebar navigation.' => 'The section that will be selected by default in the sidebar navigation.',
    ...
    'Disable this setting to stop Sprout Forms from saving all form submission data to the Craft database. Existing data will not be deleted, but will no longer be visible in the Control Panel.' => 'Disable this setting to stop Sprout Forms from saving all form submission data to the Craft database. Existing data will not be deleted, but will no longer be visible in the Control Panel.',
    'This setting will default to \'Forms\' while the save data setting is disabled.' => 'This setting will default to \'Forms\' while the save data setting is disabled.',
    'Failed to mark entry as Spam' => 'Failed to mark entry as Spam',
    'Enable the setting to save data to the Craft database to select the Entries option.' => 'Enable the setting to save data to the Craft database to select the Entries option.',
    'This setting is unavailable because saving data to the database is disabled in the [global settings]({settingsUrl}).' => 'This setting is unavailable because saving data to the database is disabled in the [global settings]({settingsUrl}).',
    ...
    'This setting is disabled because saving data to the database is disabled in the [global settings]({settingsUrl}).' => 'This setting is disabled because saving data to the database is disabled in the [global settings]({settingsUrl}).',
    'Entries marked as Spam.' => 'Entries marked as Spam.',
    'Are you sure you want to mark as spam the selected form entries?' => 'Are you sure you want to mark as spam the selected form entries?',
    ...
    'Mark as' => 'Mark as',
    'Disable this setting to stop Sprout Forms from saving all form submission data to the Craft database and hide the Form Entries tab. Existing data will not be deleted, but will no longer be visible in the Control Panel.' => 'Disable this setting to stop Sprout Forms from saving all form submission data to the Craft database and hide the Form Entries tab. Existing data will not be deleted, but will no longer be visible in the Control Panel.',
    'Spam Log' => 'Spam Log',
    'Not Spam' => 'Not Spam',
    'forms' => 'forms',
    ...
    'This setting defaults to the \'Forms\' section while the save data setting is disabled.' => 'This setting defaults to the \'Forms\' section while the save data setting is disabled.',
