...
define('CRAFT_BASE_PATH', realpath(str_replace("plugins/sproutforms", '', exec('pwd'))).'/');
...
// Load plugin
require_once CRAFT_PLUGINS_PATH.'sproutforms/SproutFormsPlugin.php';
require_once CRAFT_PLUGINS_PATH.'sproutforms/vendor/autoload.php';
