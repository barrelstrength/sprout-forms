INSERT INTO `craft_senorform_forms` (`id`, `name`, `handle`, `email_distribution_list`, `dateCreated`, `dateUpdated`, `uid`) VALUES
...
INSERT INTO `craft_senorform_fields` (`id`, `formId`, `name`, `handle`, `instructions`, `translatable`, `type`, `settings`, `validation`, `dateCreated`, `dateUpdated`, `uid`) VALUES
