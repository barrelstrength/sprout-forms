...
INSERT INTO `craft_sproutforms_forms` (`id`, `name`, `handle`, `redirectUri`, `submitButtonType`, `submitButtonText`, `email_distribution_list`, `notification_reply_to`, `notification_subject`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	(2,'Mailing List','mailingList','sproutforms/examples/multiple-forms','input','',NULL,NULL,NULL,'2013-11-12 21:38:55','2014-03-31 03:22:40','ff67708c-dee4-4242-9f9e-1d5c221763a8');
...
INSERT INTO `craft_sproutforms_fields` (`id`, `formId`, `name`, `handle`, `context`, `instructions`, `translatable`, `type`, `settings`, `validation`, `sortOrder`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	(null,2,'Name','formId2_fullName','global','',0,'PlainText','{\"placeholder\":\"\",\"maxLength\":\"\",\"multiline\":\"\",\"initialRows\":\"4\"}','required',NULL,'2013-11-15 13:50:20','2014-03-03 03:15:40','2554ab82-1937-485b-abdc-4ed285782f19'),
	(null,2,'Email','formId2_email','global','',0,'PlainText','{\"placeholder\":\"\",\"maxLength\":\"\",\"multiline\":\"\",\"initialRows\":\"2\"}','required',NULL,'2013-11-15 14:34:57','2014-03-03 03:14:30','eeaed567-ccc7-4e5d-935d-298605395b12');
...
ALTER TABLE  `craft_sproutforms_content` 
ADD `formId2_email` text NULL AFTER `formId`;

ALTER TABLE `craft_sproutforms_content` 
ADD `formId2_fullName` text NULL AFTER `formId`;
