 ...
 */
class m140225_090533_sproutForms_addFieldsSproutformsForms extends BaseMigration
{
	/**
	...
	{		
				...
				if ($sproutFormsTable)
				{
					...
					if ($sproutFormsTable->getColumn('notification_subject') == null)
					{
					    ...
					    $this->addColumnAfter('sproutforms_forms', 'notification_subject', array(AttributeType::String, 'required' => false), 'email_distribution_list');
