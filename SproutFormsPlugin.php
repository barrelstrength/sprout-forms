...
class SproutFormsPlugin extends BasePlugin
{
    ...
    {
        return array(
            'sproutforms/new' => 'sproutforms/_edit',
            
            'sproutforms/edit\/(?P<formId>\d+)' => 'sproutforms/_edit',
            
            'sproutforms/fields/new' => 'sproutforms/fields/_edit',
            
            'sproutforms/fields/edit/(?P<fieldId>\d+)' => 'sproutforms/fields/_edit',
            
            'sproutforms/entries/view/(?P<entryId>\d+)' => 'sproutforms/entries/_view',
            
            'sproutforms/examples' => 'sproutforms/plugin_settings/install_examples'
        );
    }
